...
def local_facts(host):
    ...
    if local_fact:
        return local_fact.get("paperless", {})
    else:
        return dict()
...
def test_directories(host, get_vars):
    ...
    directories = [
        f"{install_path}/paperless-data",
        f"{install_path}/paperless-data/redis-data",
        f"{install_path}/paperless-data/data",
        f"{install_path}/paperless-data/media",
        f"{install_path}/paperless-data/export",
        f"{install_path}/paperless-data/consume",
    ]
...
def test_files(host, get_vars):
    ...
    files = [
        f"{install_path}/active/paperless-compose.conf",
